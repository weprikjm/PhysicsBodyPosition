...
public:
	...
	void CreateBox(int coordX, int coordY, int base, int height);
	shapePosition* CreateCircle(int coordX, int coordY, int radius);
	void CreateChain(int coordX, int coordY);

private:

	bool debug;
	b2World* world;
	p2List<b2Body*> listBodies;
};
